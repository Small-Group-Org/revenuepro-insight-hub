...
export const SetTargets = () => {
  ...
  useEffect(() => {
    if (currentTarget) {
      ...
      // If currentTarget is an array (for monthly/yearly), handle accordingly
      if (Array.isArray(currentTarget) && (period === 'monthly' || period === 'yearly')) {
        // Sum revenue, keep other fields from the first object
        ...
        // Single object (weekly or fallback)
